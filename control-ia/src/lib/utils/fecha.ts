...
export function rangoPeriodoParaguay(periodo: "este_mes" | "mes_pasado" | "esta_semana"): { desde: string; hasta: string } {
  ...
  if (periodo === "mes_pasado") {
    ...
    // Truco seguro de calendario: el "día 0" del mes siguiente es el último día del mes anterior.
...
/** Primer y último día (hoy) del mes actual en Paraguay — usado por Dashboard/Reportes/Negocio. */
